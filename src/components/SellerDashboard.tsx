            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {[
                  ...
                  {
                    product: "Vue Component Library",
                    buyer: "Sarah K.",
                    amount: 129,
                    date: "5 hours ago",
                  },
                  {
                    product: "API Analytics Tool",
                    buyer: "Mike R.",
                    amount: 79,
                    date: "1 day ago",
                  },
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-semibold text-gray-900">2 open</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="grid md:grid-cols-3 gap-6 mb-6">
              ...
              <div className="text-center p-4 bg-orange-50 rounded-lg">
                ...
                <div className="text-2xl font-bold text-orange-600">$1,868</div>
                <div className="text-sm text-gray-600">Platform Fees (15%)</div>
              </div>
            </div>

            <div className="flex justify-center">
              <button className="bg-green-600 text-white px-6 py-3 rounded-lg hover:bg-green-700 transition-colors btn-animate">
                Request Payout
              </button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="space-y-4">
              {[
                {
                  from: "John Smith",
                  subject: "Question about React Dashboard Pro",
                  time: "2 hours ago",
                  unread: true,
                },
                {
                  from: "Lisa Johnson",
                  subject: "Feature request for Vue Library",
                  time: "1 day ago",
                  unread: false,
                },
                {
